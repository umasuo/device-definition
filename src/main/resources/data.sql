...
VALUES ('77616169-cc17-4051-8657-f706e7f4d303', 1498647420000, NULL, '大家电', 1498647420492, '冰箱', 0) on conflict DO NOTHING;

INSERT INTO product_type (id, created_at, description, group_name, last_modified_at, name, version)
VALUES ('be9b50f3-0e7e-4398-8d74-7cf55e66f282', 1498647421000, NULL, '小家电', 1498647420512, '扫地机器人', 0) on conflict DO NOTHING;
...
--
--INSERT INTO product_type (id, created_at, description, group_name, last_modified_at, name, version)
--VALUES ('10000', 1498647422000, NULL, '电工照明', 1498647420492, '插座', 0) on conflict DO NOTHING;
--
--INSERT INTO product_type (id, created_at, description, group_name, last_modified_at, name, version)
--VALUES ('10001', 1498647423000, NULL, '电工照明', 1498647420492, '开关', 0) on conflict DO NOTHING;
--
--INSERT INTO product_type (id, created_at, description, group_name, last_modified_at, name, version)
--VALUES ('10002', 1498647424000, NULL, '电工照明', 1498647420492, '照明', 0) on conflict DO NOTHING;
--
---- 关联产品类型与其指令
--
---- 插座与其指令
